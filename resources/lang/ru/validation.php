...
return [
    ...
    */
    ...
    'custom' => [
        'coin_currency' => [
            'country_currency_not_relevant' => 'Валюта не принадлежит выбранной стране.',
        ],
        'picture_files' => [
            "picture_files_empty" => 'Должен присутствовать хотя бы один файл.',
            'picture_files_only' => 'Одновременно можно загрузить только один файл.',
            'picture_files_not_exists' => "Файл изображения не существует."
        ],
        "seo" => [
            "required_all_or_null" => "Заполните все поля SEO или ни одного."
        ],
        "article" => [
            "required_all_or_null" => "Заполните все поля статьи или ни одного."
        ]
    ],

    'attributes' => [
        "coin-country" => "страна",
        "coin-nominal" => "номинал",
        "coin-coinage" => "чекан монет",
        "coin-material" => "материал",
        "coin-currency" => "валюта",
        "coin-shape" => "форма",
        "coin-theme" => "тема",
        "coin-mintmark" => "матка завода изготовителя",
        "coin-year" => "год",
        "coin-quality" => "качество",
        "coin-storage" => "место хранения",

        "picture-obverse" => "аверс изображения",
        "picture-reverse" => "обратная сторона изображения",
