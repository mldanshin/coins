...
final class FilterRequest extends BaseRequest implements BuilderQueryContract
{
    ...
    public function rules(): array
    {
        return [
            ...
            "qualities.*" => "nullable|numeric|exists:qualities,id",
            "storages" => "nullable|array",
            "storages.*" => "nullable|numeric|exists:storages,id",
        ];
    }
    ...
    public function shareQuery(BuilderQuery $builderQuery): void
    {
        ...
        $builderQuery->addArrayString("qualities", $this->input("qualities"));
        $builderQuery->addArrayString("storages", $this->input("storages"));
    }
}
