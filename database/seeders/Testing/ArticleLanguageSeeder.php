...
class ArticleLanguageSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->create(3, 2, 1, "A story about a penny from the USSR", "In this article I will tell a story about a penny of the USSR...");
        $this->create(4, 2, 2, "История про копейку времён СССР", "В этой статье я расскажу историю о копейке времен СССР...");
        $this->create(5, 3, 2, "Я копейка!", "Статья без перевода на английский...");
    }
